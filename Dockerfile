...
FROM node:22.21.1-alpine AS new-frontend-build
...
FROM ghcr.io/usa-reddragon/mesh-base:main@sha256:59d23e01e1531db829fc4c86ccb525684552e2fa9802eb8ab6c9a61d45041d7e
